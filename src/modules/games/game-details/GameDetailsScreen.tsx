...
import {
  deleteAllScores,
  deleteLastScore,
} from '../services/deleteScores';
import { getGameById } from '../services/getGameById';
import type { Game } from '../types/game.types';

import DeleteScoreBottomSheet from './components/DeleteScoreBottomSheet';
...
const GameDetailsScreen = () => {
  ...
  const deleteScoreSheetRef = useRef<BottomSheetModal>(null);
  ...
  const handleOpenDeleteScoreSheet = () => {
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <BottomSheetModalProvider>
            ...
            <View className="mb-[18px]">
              <View className="mb-1.5 min-h-[38px] flex-row items-center justify-between gap-3">
                ...
                <Pressable
                  ...
                  onPress={() =>
                    router.push({
                      pathname: '/games/[gameId]/add-score',
                      params: { gameId },
                    })
                  }
                >
            ...
            <View className="mb-[18px]">
              <View className="mb-1.5 min-h-[38px] flex-row items-center justify-between gap-3">
                ...
                <Pressable
                  ...
                  onPress={handleOpenDeleteScoreSheet}
        ...
        <DeleteScoreBottomSheet
          ref={deleteScoreSheetRef}
          hasScores={Boolean(game?.rounds.length)}
          onDeleteLastScore={handleDeleteLastScore}
          onDeleteAllScores={handleDeleteAllScores}
        />
      </BottomSheetModalProvider>
